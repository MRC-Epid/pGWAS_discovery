...
## script to run coloc for mapping protein gene pairs using GTEx sQTL data
...
## store results
write.table(res.coloc, paste0("tissue_coloc_sQTL/", soma,".", intr, ".", gene, ".", chr.s, ".", pos.s, ".", pos.e, ".txt"), sep="\t", row.names=F)

...
## script to run coloc for mapping protein gene pairs using GTEx eQTL data
## Maik Pietzner 05/01/2021
rm(list=ls())
...
## store results
write.table(res.coloc, paste0("tissue_coloc/", soma,".", gene, ".", chr.s, ".", pos.s, ".", pos.e, ".txt"), sep="\t", row.names=F)
